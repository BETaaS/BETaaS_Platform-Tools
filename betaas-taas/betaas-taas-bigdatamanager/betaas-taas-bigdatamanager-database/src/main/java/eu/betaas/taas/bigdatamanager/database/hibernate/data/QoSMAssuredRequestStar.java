...
@Entity
@Table(name = "QOSM_ASSURED_REQUEST_STAR")
public class QoSMAssuredRequestStar implements java.io.Serializable {
	...
	public QoSMAssuredRequestStar() {
	}
	
	public QoSMAssuredRequestStar(QoSMAssuredRequestStar req) {
	...
	public QoSMAssuredRequestStar(String serviceId, Integer requestId, Double maxResponseTime, 
			Double minInterRequestTime, String gatewayId, Double maxBurstSize, Double averageRate) {
