...
public class FuzzyCalculator 
{
	...
	{		       
       fileName = "fuzzy/ThingServices.fcl";       
	}
	...
	{		
		...
		{    
        	...
        	ThingServiceTrust currentTrust = myBDM.getTrustData(idEntity);
        	myHash.put("security", new Double (currentTrust.getSecurityMechanisms()));
    		myHash.put("qos", new Double (currentTrust.getQoSFulfillment()));
    		myHash.put("dependability", new Double (currentTrust.getDependability()));
    		myHash.put("scalability", new Double (currentTrust.getScalability()));
    		myHash.put("battery", new Double (currentTrust.getBatteryLoad()));
    		myHash.put("data", new Double (currentTrust.getDataStability()));
		}
		catch (Exception ex)
		{
