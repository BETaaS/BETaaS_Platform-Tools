 ...
 *       &lt;sequence>
 *         &lt;element name="instance_type" type="{}link" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "instance_type_collection")
public class InstanceTypeCollection {

    @XmlElement(name = "instance_type")
    protected List<Link> instanceType;
     ...
     * 
     */
    public List<Link> getInstanceType() {
        if (instanceType == null) {
            instanceType = new ArrayList<Link>();
        }
