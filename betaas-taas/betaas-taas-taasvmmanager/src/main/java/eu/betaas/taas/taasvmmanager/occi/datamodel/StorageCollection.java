 ...
 *       &lt;sequence>
 *         &lt;element name="storage" type="{}link" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "storage_collection")
public class StorageCollection {

    protected List<Link> storage;
     ...
     * 
     */
    public List<Link> getStorage() {
        if (storage == null) {
            storage = new ArrayList<Link>();
        }
        return this.storage;
    }
