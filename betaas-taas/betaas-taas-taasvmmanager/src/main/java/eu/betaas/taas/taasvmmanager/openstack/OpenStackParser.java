...
public class OpenStackParser {
    ...
    private static final String OSSTATE_ACTIVE         = "ACTIVE";
    private static final String OSSTATE_BUILDING       = "BUILDING";
    private static final String OSSTATE_DELETED        = "DELETED";
    private static final String OSSTATE_ERROR          = "ERROR";
    private static final String OSSTATE_HARD_REBOOT   = "HARD_REBOOT";
    private static final String OSSTATE_PASSWORD       = "PASSWORD";
    private static final String OSSTATE_PAUSED         = "PAUSED";
    private static final String OSSTATE_REBOOT         = "REBOOT";
    private static final String OSSTATE_REBUILD        = "REBUILD";
    private static final String OSSTATE_RESCUED        = "RESCUED";
    private static final String OSSTATE_RESIZED        = "RESIZED";
    private static final String OSSTATE_REVERT_RESIZE = "REVERT_RESIZE";
    private static final String OSSTATE_SHUTOFF        = "SHUTOFF";
    private static final String OSSTATE_SOFT_DELETED  = "SOFT_DELETED";
    private static final String OSSTATE_STOPPED        = "STOPPED";
    private static final String OSSTATE_SUSPENDED      = "SUSPENDED";
    private static final String OSSTATE_UNKNOWN        = "UNKNOWN";
    private static final String OSSTATE_VERIFY_RESIZE = "VERIFY_RESIZE";
    
    private static final String MALFORMEDRESPONSE =
            "Malformed response";
    private static final String BADREFERENCE =
            "Bad reference, %s %s does not exist.";
    private static final String BADSTATE =
            "Bad state, %s does not exist.";
    private static final String BADADDRESS =
