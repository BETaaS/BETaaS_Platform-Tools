 ...
 *       &lt;sequence>
 *         &lt;element name="network" type="{}link" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "network_collection")
public class NetworkCollection {

    protected List<Link> network;
     ...
     * 
     */
    public List<Link> getNetwork() {
        if (network == null) {
            network = new ArrayList<Link>();
        }
        return this.network;
    }
