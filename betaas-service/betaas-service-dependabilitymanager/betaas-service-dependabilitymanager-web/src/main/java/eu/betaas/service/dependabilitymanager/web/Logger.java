...
package eu.betaas.service.dependabilitymanager.web;
...
public class Logger {
	...
	public final static String DEFAULT_LOG_FILE_NAME = "DependabilityManager.log";
	...
	public void open() throws Exception {
		try {
			...
			mStream = null;
			throw new Exception("DependabilityManager cannot open log file: " + mFileName + ". " + e.getMessage());
		}
	}
