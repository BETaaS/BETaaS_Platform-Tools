...
/**
 * This interface provides methods for token request and validation to the 
 * remote GWs
 * 
 ...
 *
 */
public interface IAuthExtService {
	public String getToken(String gwId, String thingServiceId, String subjectType, byte[] subjectPublicKeyInfo) throws Exception;
