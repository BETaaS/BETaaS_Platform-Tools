...
/**
 * This class describes the Token data structure
 * 
...
public class Token {
	...
	@XmlElement(name = "CapabilityExternal")
	private List<CapabilityExternal> capability;

	public List<CapabilityExternal> getCapability() {
		if(capability==null){
			capability = new ArrayList<CapabilityExternal>();
		}
		return capability;
	}
}
