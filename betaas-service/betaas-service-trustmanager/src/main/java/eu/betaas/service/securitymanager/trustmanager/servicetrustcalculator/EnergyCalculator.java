...
import eu.betaas.service.securitymanager.trustmanager.serviceproxy.Kernel32;
...
public class EnergyCalculator 
{
	...
	public void setPreOperationData(GatewayInfo information)
	{
		logger.debug("Converting Thing Service Data...");
				
		// Retrieve last data		
		ArrayList<GatewayTrustData> baseData = information.getDataList();
		...
		gatewayId = information.getGatewayId();		
	}
	...
	public static void main(String[] args) 
	{
		...
		EnergyCalculator myCalc = new EnergyCalculator ();
